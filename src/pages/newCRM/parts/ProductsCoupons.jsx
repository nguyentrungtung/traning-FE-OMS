...
import ProductsCoupons from '../../../modules/components/tables/content/ProductsCoupons';

function ProductsCouponsPagination() {
  const [productsData, setProductsData] = useState([]);
  useEffect(()=>{
      fetch('https://api.npoint.io/1937d908d7e636d6da3e')
      ...
      <main className='d-flex gap-12px'>
        <div className="main-part flex-fill">
          <ProductTable.Wrapper>
            <ProductTable.Header tableName="Mã giảm giá">
            ...
            <ProductTable.Body>
              <ProductsCoupons data={productsData} itemsPerPage={10}/>
            </ProductTable.Body>
          </ProductTable.Wrapper>
        </div>
      </main>
...
export default ProductsCouponsPagination;