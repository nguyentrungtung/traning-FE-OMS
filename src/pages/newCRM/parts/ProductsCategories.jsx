...
import ProductsCategories from '../../../modules/components/tables/content/ProductsCategories';

function ProductsCategoriesPagination() {
  const [productsData, setProductsData] = useState([]);
  useEffect(()=>{
      fetch('https://api.npoint.io/c3863d7ad9deafda4e70')
      ...
      <main className='d-flex gap-12px'>
        <div className="main-part flex-fill">
          <ProductTable.Wrapper>
            <ProductTable.Header tableName="Danh mục">
            ...
            <ProductTable.Body>
              <ProductsCategories data={productsData} itemsPerPage={10}/>
            </ProductTable.Body>
          </ProductTable.Wrapper>
        </div>
      </main>
...
export default ProductsCategoriesPagination;