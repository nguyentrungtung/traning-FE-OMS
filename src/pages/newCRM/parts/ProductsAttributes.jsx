...
import ProductsAttributes from '../../../modules/components/tables/content/ProductsAttributes';

function ProductsAttributesPagination() {
      ...
      <main className='d-flex gap-12px'>
        <div className="main-part flex-fill">
          <ProductTable.Wrapper>
            <ProductTable.Header tableName="Thuộc tính">
            ...
            <ProductTable.Body>
              <ProductsAttributes data={productsData} itemsPerPage={10}/>
            </ProductTable.Body>
          </ProductTable.Wrapper>
        </div>
      </main>
...
export default ProductsAttributesPagination;