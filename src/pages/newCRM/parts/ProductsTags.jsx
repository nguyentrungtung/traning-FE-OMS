...
import ProductsTags from '../../../modules/components/tables/content/ProductsTags';

function ProductsTagsPagination() {
      ...
      <main className='d-flex gap-12px'>
        <div className="main-part flex-fill">
          <ProductTable.Wrapper>
            <ProductTable.Header tableName="Thẻ sản phẩm">
            ...
            <ProductTable.Body>
              <ProductsTags data={productsData} itemsPerPage={10}/>
            </ProductTable.Body>
          </ProductTable.Wrapper>
        </div>
      </main>
...
export default ProductsTagsPagination;