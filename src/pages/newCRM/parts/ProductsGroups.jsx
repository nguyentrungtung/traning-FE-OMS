...
import ProductsGroups from '../../../modules/components/tables/content/ProductsGroups';

function ProductsGroupsPagination() {
      ...
      <main className='d-flex gap-12px'>
        <div className="main-part flex-fill">
          <ProductTable.Wrapper>
            <ProductTable.Header tableName="Nhóm sản phẩm">
            ...
            <ProductTable.Body>
              <ProductsGroups data={productsData} itemsPerPage={10}/>
            </ProductTable.Body>
          </ProductTable.Wrapper>
        </div>
      </main>
...
export default ProductsGroupsPagination;