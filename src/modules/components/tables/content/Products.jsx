    ...
    return(
        <div className='table-list__content'>
                        ...
                        <tr key={index}>
                            ...
                            <td>
                                <div className="product__prev">
                                    ...
                                    <span className='text'>
                                        <div className="text__name">{item.name}</div>
                                        <div className="text__code">{`Mã sản phẩm: ${item.attr.code}`}</div>
                                    </span>
                                </div>
                            </td>
                            <td>{item.price}</td>
            ...
            <div className="pagination__container">
                ...
                />
                <div>Hiển thị sản phẩm thứ {offset} - {offset + currentItems.length}/ Tổng số {data.length} sản phẩm</div>
            </div>
      </div>
    )
}
